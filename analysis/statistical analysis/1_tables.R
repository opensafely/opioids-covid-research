...
table <- read_csv(here::here("output", "released_outputs", "table_full_population.csv")) %>%
  mutate(pcent_opioid = round(opioid_any_round / total_pop_round * 100, 1),
         ...
         opioid_per_1000 = round(opioid_per_1000, 2),
         opioid_per_1000_std = round(opioid_per_1000_std, 2)) %>%
